...
_rifle = "rhs_weap_ak104_zenitco01_b33";
_riflemag = "hlc_30Rnd_762x39_b_ak";
_riflemag_tr = "hlc_30Rnd_762x39_b_ak";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = "hlc_smg_MP5N";
_carbinemag = "hlc_30Rnd_9x19_GD_MP5";
_carbinemag_tr = "hlc_30Rnd_9x19_GD_MP5";

// Standard Submachine Gun/Personal Defence Weapon (Aircraft Pilot, Submachinegunner)
_smg = "hlc_smg_MP5N";
_smgmag = "hlc_30Rnd_9x19_GD_MP5";
...
_smokegrenade = "UK3CB_BAF_SmokeShell";
_smokegrenadegreen = "UK3CB_BAF_SmokeShellGreen";
_smokegrenadered = "UK3CB_BAF_SmokeShellRed";
...
// Backpacks
_bagsmall = "B_Kitbag_rgr";			// carries 120, weighs 20
...
_baseUniform = ["rhsgref_uniform_og107_erdl","UK3CB_BAF_U_JumperUniform_Plain","LOP_U_UA_Fatigue_02","LOP_U_UVF_Fatigue_BL_OSW","rhsgref_uniform_ERDL"];
_baseHelmet = ["rhs_6b7_1m","rhs_6b7_1m_bala1","rhs_6b7_1m_bala2","rhs_beanie_green","rhs_Booniehat_m81"];
_baseGlasses = [];

// Vests
_lightRig = ["V_TacVest_camo","V_TacVest_oli","V_I_G_resistanceLeader_F","MNP_Vest_OD_B","V_Chestrig_rgr"];
_mediumRig = ["V_TacVest_camo","V_TacVest_oli","V_I_G_resistanceLeader_F","MNP_Vest_OD_B","V_Chestrig_rgr"]; 	// default for all infantry classes
_heavyRig = ["V_TacVest_camo","V_TacVest_oli","V_I_G_resistanceLeader_F","MNP_Vest_OD_B","V_Chestrig_rgr"];
...
// Pilot
_pilotUniform = ["UK3CB_BAF_U_JumperUniform_Plain","LOP_U_UA_Fatigue_02","LOP_U_UVF_Fatigue_BL_OSW","rhsgref_uniform_ERDL"];
_pilotHelmet = ["H_PilotHelmetHeli_B"];
_pilotRig = ["V_TacVest_camo","V_TacVest_oli","V_I_G_resistanceLeader_F","MNP_Vest_OD_B","V_Chestrig_rgr"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["UK3CB_BAF_U_JumperUniform_Plain","LOP_U_UA_Fatigue_02","LOP_U_UVF_Fatigue_BL_OSW","rhsgref_uniform_ERDL"];
_crewHelmet = ["H_HelmetCrew_B"];
_crewRig = ["V_TacVest_camo","V_TacVest_oli","V_I_G_resistanceLeader_F","MNP_Vest_OD_B","V_Chestrig_rgr"];
_crewGlasses = [];
...
// Spec Op
_sfuniform = ["UK3CB_BAF_U_JumperUniform_Plain","LOP_U_UA_Fatigue_02","LOP_U_UVF_Fatigue_BL_OSW","rhsgref_uniform_ERDL"];
_sfhelmet = ["rhs_6b7_1m","rhs_6b7_1m_bala1","rhs_6b7_1m_bala2","rhs_beanie_green","rhs_Booniehat_m81"];
_sfRig = ["V_TacVest_camo","V_TacVest_oli","V_I_G_resistanceLeader_F","MNP_Vest_OD_B","V_Chestrig_rgr"];
_sfGlasses = [];
...
// LOADOUT: DESIGNATED MARKSMAN
	case "dm":
	{
		_unit addmagazines [_DMriflemag,13];
