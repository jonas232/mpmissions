...
case "m":
{
	...
	if (_loadout <= 1) then {
		...
		(unitBackpack _unit) addMagazineCargoGlobal [_smokered, 2];
		(unitBackpack _unit) addMagazineCargoGlobal [_smokegreen, 2];
...
case "g":
{
	...
	if (_loadout == 1) then {
		...
		(unitBackpack _unit) addMagazineCargoGlobal [_glflaregreen, 3];
		(unitBackpack _unit) addMagazineCargoGlobal [_glflarered, 3];
...
case "rat":
{
	...
	if (_loadout == 1) then {
		_unit addBackpack _bagsmall;
		clearMagazineCargoGlobal (unitBackpack _unit);
		(unitBackpack _unit) addItemCargoGlobal ["rhs_weap_rshg2",1];
		(unitBackpack _unit) addMagazineCargoGlobal [_grenade, 2];
		(unitBackpack _unit) addMagazineCargoGlobal [_mgrenade, 2];
		(unitBackpack _unit) addMagazineCargoGlobal [_smokegrenade, 2];
	};
