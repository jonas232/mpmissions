...
if(!isServer && hasInterface) then  //run on all player clients excl. player host and excl. headless clients
{
	waitUntil {!isNull player}; 
};

if (!isdedicated && hasInterface) then { //run on all player clients incl. player host and excl. headless clients
