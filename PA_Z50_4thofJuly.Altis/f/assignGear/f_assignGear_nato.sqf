...
_smg = "rhs_weap_hk416d10";
_smgmag = "rhs_mag_30Rnd_556x45_M855_Stanag";
_smgmag_tr = "rhs_mag_30Rnd_556x45_M855_Stanag_Tracer_Red";
...
_glrifle = "rhs_weap_m4a1_blockII_M203_bk";
...
_chemyellow =  "ACE_HandFlare_White";
_chemblue = "ACE_HandFlare_White";
...
_baseHelmet = ["rhsusf_opscore_ut_pelt_cam","rhsusf_opscore_ut_pelt_nsw","rhsusf_opscore_ut_pelt"];
_baseGlasses = ["rhsusf_oakley_goggles_blk","rhsusf_oakley_goggles_clr","rhsusf_oakley_goggles_ylw"];

// Vests
_lightRig = ["rhsusf_mbav_rifleman","rhsusf_mbav_rifleman"];
_mediumRig = ["rhsusf_mbav_rifleman","rhsusf_mbav_rifleman"]; 	// default for all infantry classes
...
_pilotHelmet = ["rhsusf_hgu56p_visor_usa"];
...
_crewGlasses = ["rhsusf_oakley_goggles_blk","rhsusf_oakley_goggles_clr","rhsusf_oakley_goggles_ylw"];
...
_sfhelmet = ["rhsusf_opscore_ut_pelt_cam","rhsusf_opscore_ut_pelt_nsw","rhsusf_opscore_ut_pelt"];
_sfRig = ["rhsusf_mbav_grenadier"];
_sfGlasses = ["rhsusf_oakley_goggles_blk","rhsusf_oakley_goggles_clr","rhsusf_oakley_goggles_ylw"];
