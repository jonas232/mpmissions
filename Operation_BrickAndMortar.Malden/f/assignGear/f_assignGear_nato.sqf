...
// ATTACHMENTS - PRIMARY
_attach1 = "rhsusf_acc_M952V";	// Flashlight
...
_rifle = "hlc_rifle_samr2";
_riflemag = "rhs_mag_30Rnd_556x45_M855A1_Stanag_No_Tracer";
_riflemag_tr = "rhs_mag_30Rnd_556x45_M855A1_Stanag_Tracer_Red";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = "rhs_weap_mk18";
_carbinemag = "rhs_mag_30Rnd_556x45_M855A1_Stanag_No_Tracer";
...
_glriflemag = "rhs_mag_30Rnd_556x45_M855A1_Stanag_No_Tracer";
...
// Automatic Rifleman
_AR = "rhs_weap_m27iar";
_ARmag = "hlc_50rnd_556x45_EPR";
_ARmag_tr = "hlc_50rnd_556x45_EPR";
...
_baseUniform = ["UK3CB_BAF_U_CombatUniform_MTP_TShirt","UK3CB_BAF_U_CombatUniform_MTP_TShirt_RM","MNP_CombatUniform_Ranger_A","MNP_CombatUniform_Ranger_B"];
_baseHelmet = ["rhsusf_mich_bare","rhsusf_mich_bare_alt","rhsusf_mich_bare_headset","rhsusf_mich_bare_norotos","rhsusf_mich_bare_norotos_alt","rhsusf_mich_bare_norotos_arc_alt"];
_baseGlasses = [];

// Vests
_lightRig = ["V_BandollierB_cbr","V_BandollierB_khk"];
_mediumRig = ["MNP_Vest_Scorpion_1","MNP_Vest_Scorpion_2"]; 	// default for all infantry classes
...
// CARGO: TRUCK - room for 50 weapons and 200 cargo items
	case "v_tr":
	{
		...
		_unit addItemCargoGlobal [_firstaid,8];
		_unit addItemCargoGlobal ["B_Carryall_oli",2];
	...
	case "crate_med":
{
		...
		_unit addMagazineCargoGlobal [_mgrenade, 16];
