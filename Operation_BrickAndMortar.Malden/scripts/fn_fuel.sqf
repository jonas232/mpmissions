...
while { alive _vehicle} do {
    ...
    _rate = _vehicle getVariable ["fox_fuel_settings_rate", 0.00250 ];
    _loadMultiplier = _vehicle getVariable ["fox_fuel_settings_loadMultiplier", 0.00010 ];
    _tooFastRate =_vehicle getVariable ["fox_fuel_settings_tooFastRate", 0.00300 ];
    _tooSlowRate = _vehicle getVariable ["fox_fuel_settings_tooSlowRate", 0.00200 ];
