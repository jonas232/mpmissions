...
_scope1 = "rhsusf_acc_eotech_552_d";	// Holo
_scope2 = "rhsusf_acc_ACOG_d";			// ACOG
_scope3 = "rhsusf_acc_ELCAN";			// MGO

_bipod1 = "rhs_acc_grip_ffg2";			// Default bipod
_bipod2 = "bipod_02_F_blk";				// Black bipod

// Default setup
_attachments = [_attach1,_scope1,_silencer1,_bipod1]; // The default attachment set for most units, overwritten in the individual unitType
...
_rifle = "rhs_weap_m4a1_blockII_KAC_d";
_riflemag = "rhs_mag_30Rnd_556x45_M855_Stanag";
_riflemag_tr = "rhs_mag_30Rnd_556x45_M855_Stanag_Tracer_Green";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = "rhs_weap_m4a1_d_mstock";
_carbinemag = "rhs_mag_30Rnd_556x45_M855_Stanag";
_carbinemag_tr = "rhs_mag_30Rnd_556x45_M855_Stanag_Tracer_Green";

// Standard Submachine Gun/Personal Defence Weapon (Aircraft Pilot, Submachinegunner)
_smg = "rhsusf_weap_MP7A2_desert";
...
_glrifle = "rhs_weap_m4a1_m203s_d";
_glriflemag = "rhs_mag_30Rnd_556x45_M855_Stanag";
_glriflemag_tr = "rhs_mag_30Rnd_556x45_M855_Stanag_Tracer_Green";
...
_chemred = "ACE_Chemlight_HiRed";
_chemyellow =  "ACE_Chemlight_HiWhite";
...
_bagraven = "B_rhsusf_B_BACKPACK";					// Raven UAV
...
_crew = ["vc","vg","vd"];
_ghillie = ["sn","sp"];
_specOp = ["co","dc","gren","ftl"];

// Basic clothing
// The outfit-piece is randomly selected from the array for each unit
_baseUniform = ["rhs_uniform_FROG01_d","rhs_uniform_g3_tan"];
_baseHelmet = ["rhsusf_mich_bare_norotos_alt_tan","rhsusf_mich_bare_norotos_alt_tan_headset","rhsusf_mich_bare_norotos_arc_alt_tan"];
_baseGlasses = [];
...
// Diver
_diverUniform =  ["rhs_uniform_FROG01_d","rhs_uniform_g3_tan"];
_diverHelmet = ["rhsusf_mich_bare_norotos_alt_tan","rhsusf_mich_bare_norotos_alt_tan_headset","rhsusf_mich_bare_norotos_arc_alt_tan"];
_diverRig = ["rhsusf_mbav_rifleman"];
_diverGlasses = [];

// Pilot
_pilotUniform = ["rhs_uniform_g3_tan"];
_pilotHelmet = ["rhsusf_hgu56p_visor_mask_saf"];
_pilotRig = ["rhsusf_mbav_light"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["rhs_uniform_g3_tan"];
...
// Spec Op
_sfuniform = ["rhs_uniform_FROG01_d","rhs_uniform_g3_tan"];
_sfhelmet = ["rhsusf_mich_bare_norotos_alt_tan","rhsusf_mich_bare_norotos_alt_tan_headset","rhsusf_mich_bare_norotos_arc_alt_tan"];
...
// LOADOUT: COMMANDER
	case "co":
	{
		...
		_unit addmagazines [_glriflemag_tr,5];
		_unit addmagazines [_glmag,2];
		_unit addmagazines [_glsmokewhite,4];
		_unit addmagazines [_glsmokegreen,4];
...
// LOADOUT: MEDIC
	case "m":
	{
		...
		_unit addmagazines [_carbinemag_tr,5];
		_unit addweapon _carbine;
		_unit addmagazines [_smokegrenade,4];
		_unit addmagazines [_smokegrenadegreen,4];
