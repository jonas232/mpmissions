...
_carbine = _rifle;
_carbinemag = _riflemag;
_carbinemag_tr = _riflemag_tr;
...
_glrifle = _rifle;
_glriflemag = _riflemag;
_glriflemag_tr = _riflemag_tr;
_glmag = _riflemag;

// Smoke for FTLs, Squad Leaders, etc
_glsmokewhite = _riflemag;
_glsmokegreen = _riflemag;
_glsmokered = _riflemag;

// Flares for FTLs, Squad Leaders, etc
_glflarewhite = _riflemag;
_glflarered = _riflemag;
_glflareyellow = _riflemag;
_glflaregreen = _riflemag;
...
_smokegrenadegreen = _smokegrenade;
...
// Backpacks
_bagsmall = "UK3CB_BAF_B_Bergen_OLI_Rifleman_A";			// carries 120, weighs 20
_bagmedium = "UK3CB_BAF_B_Bergen_OLI_Rifleman_A";				// carries 240, weighs 30
_baglarge =  "UK3CB_BAF_B_Bergen_OLI_Rifleman_A"; 			// carries 320, weighs 40
_bagmediumdiver =  "rhs_medic_bag";		// used by divers
...
_baseHelmet = ["rhsgref_helmet_M1_bare"];
_baseGlasses = [];
...
// Diver
_diverUniform =  ["MNP_CombatUniform_OD_Rg"];
_diverHelmet = ["rhsgref_helmet_M1_bare"];
_diverRig = ["rhs_6sh46"];
_diverGlasses = [];
