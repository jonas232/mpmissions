...
_smg = "hlc_rifle_ak47";
_smgmag = "hlc_30Rnd_762x39_b_ak";
_smgmag_tr = "hlc_30Rnd_762x39_b_ak";
...
_glrifle = "hlc_rifle_ak47";
_glriflemag = "hlc_30Rnd_762x39_b_ak";
_glriflemag_tr = "hlc_30Rnd_762x39_b_ak";
_glmag = _glriflemag;

// Smoke for FTLs, Squad Leaders, etc
_glsmokewhite = _glriflemag;
_glsmokegreen = _glriflemag;
_glsmokered = _glriflemag;

// Flares for FTLs, Squad Leaders, etc
_glflarewhite = _glriflemag;
_glflarered = _glriflemag;
_glflareyellow = _glriflemag;
_glflaregreen = _glriflemag;
...
// Woodland-Hex
_baseUniform = ["U_I_C_Soldier_Bandit_4_F", "U_I_C_Soldier_Bandit_1_F", "U_I_C_Soldier_Bandit_3_F", "U_I_C_Soldier_Para_5_F"];
_baseHelmet = ["rhs_fieldcap_khk", "rhsgref_M56", "rhs_ssh68"];
_baseGlasses = [];
