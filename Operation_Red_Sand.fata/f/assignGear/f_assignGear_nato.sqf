...
// ATTACHMENTS - PRIMARY
_attach1 = "rhsusf_acc_anpeq16a";	// IR Laser
_attach2 = "acc_flashlight";	// Flashlight

_silencer1 = "muzzle_snds_M";	// 5.56 suppressor
_silencer2 = "muzzle_snds_H";	// 6.5 suppressor

_scope1 = "rhsusf_acc_RX01_NoFilter";	// Holosight
_scope2 = "rhsusf_acc_ACOG_d";			// MRCO Scope - 1x - 6x
_scope3 = "rhsusf_acc_ELCAN";			// SOS Scope - 18x - 75x

_bipod1 = "rhsusf_acc_grip3";		// Default bipod
...
// Automatic Rifleman
_AR = "hlc_lmg_MG3KWS";
_ARmag = "hlc_250Rnd_762x51_T_MG3";
_ARmag_tr = "hlc_250Rnd_762x51_T_MG3";
...
_baseUniform = ["LOP_U_ISTS_Fatigue_12","LOP_U_ISTS_Fatigue_21","LOP_U_ISTS_Fatigue_05"];
_baseHelmet = ["rhsusf_opscore_ut_pelt","rhsusf_opscore_paint_pelt","rhsusf_opscore_ut_pelt_nsw","rhsusf_opscore_mar_ut_pelt"];
_baseGlasses = ["rhsusf_shemagh_tan","rhsusf_shemagh2_tan","rhsusf_shemagh_gogg_tan","rhsusf_shemagh2_gogg_tan","rhsusf_oakley_goggles_blk","rhsusf_oakley_goggles_clr","rhsusf_oakley_goggles_ylw"];

// Vests
_lightRig = ["MNP_Vest_NZ_1"];
_mediumRig = ["MNP_Vest_NZ_1","MNP_Vest_NZ_2"]; 	// default for all infantry classes
...
// Pilot
_pilotUniform = ["LOP_U_ISTS_Fatigue_05"];
_pilotHelmet = ["rhsusf_hgu56p_visor_mask_black","rhsusf_hgu56p_visor_mask_Empire_black"];
_pilotRig = ["V_Chestrig_khk"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["U_B_CombatUniform_mcam_vest"];
_crewHelmet = ["rhsusf_cvc_alt_helmet","rhsusf_cvc_helmet"];
_crewRig = ["V_TacVest_blk"];
_crewGlasses = ["rhsusf_shemagh_tan","rhsusf_shemagh2_tan","rhsusf_shemagh_gogg_tan","rhsusf_shemagh2_gogg_tan","rhsusf_oakley_goggles_blk","rhsusf_oakley_goggles_clr","rhsusf_oakley_goggles_ylw"];
...
// Spec Op
_sfuniform = ["LOP_U_ISTS_Fatigue_12","LOP_U_ISTS_Fatigue_21","LOP_U_ISTS_Fatigue_05"];
_sfhelmet = ["MNP_Beret_Green"];
_sfRig = ["MNP_Vest_NZ_1","MNP_Vest_NZ_2"];
_sfGlasses = [];
...
if (_isMan) then {
	...
	_unit linkItem "tf_microdagr";		// Add and equip a watch
...
// LOADOUT: ASSISTANT AUTOMATIC RIFLEMAN
	case "aar":
	{
		_unit addmagazines [_riflemag,12];
...
// CARGO: CAR - room for 10 weapons and 50 cargo items
	case "v_car":
	{
		...
		_unit addMagazineCargoGlobal [_carbinemag, 16];
...
// CARGO: TRUCK - room for 50 weapons and 200 cargo items
	case "v_tr":
	{
		...
		clearItemCargoGlobal _unit;
		clearBackpackCargoGlobal _unit;
		_unit addMagazineCargoGlobal [_riflemag, 32];
	...
	case "crate_med":
{
		...
		_unit addItemCargoGlobal [_firstaid, 16];
		_unit addItemCargoGlobal ["ACE_IR_Strobe_Item", 8];
};
