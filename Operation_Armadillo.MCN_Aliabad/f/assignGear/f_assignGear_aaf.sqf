...
_scope1 = "rhsusf_acc_eotech_552";		// ACO
_scope2 = "rhsusf_acc_ACOG";			// MRCO Scope - 1x - 6x
_scope3 = "optic_AMS";					// SOS Scope - 18x - 75x
...
_rifle = "rhs_weap_m4a1_carryhandle_mstock";
...
_bagmedium = "rhsusf_assault_eagleaiii_coy";				// carries 200, weighs 30
...
_DMriflemag = "rhsusf_20Rnd_762x51_m62_Mag";
...
// Spec Op
_sfuniform = ["U_BG_Guerilla2_1","U_BG_Guerilla2_3","U_Rangemaster"];
_sfhelmet = ["rhsusf_opscore_ut_pelt","H_Cap_usblack","H_Booniehat_tan","H_Bandanna_sand"];
_sfRig = ["MNP_Vest_NZ_1","MNP_Vest_NZ_2"];
_sfGlasses = ["G_Tactical_Black","rhs_googles_black"];
...
// LOADOUT: COMMANDER
	case "co":
	{
		...
		_unit addmagazines [_chemyellow,2];
	...
	case "crate_small":
{
		...
		_unit addMagazineCargoGlobal [_glriflemag, 25];
		_unit addMagazineCargoGlobal [_armag, 10];
		_unit addMagazineCargoGlobal [_carbinemag, 10];
		_unit addMagazineCargoGlobal [_glmag, 25];
		_unit addMagazineCargoGlobal [_glsmokewhite, 4];
		_unit addMagazineCargoGlobal [_grenade, 8];
		_unit addMagazineCargoGlobal [_mgrenade, 8];
		_unit addMagazineCargoGlobal [_smokegrenade, 8];
