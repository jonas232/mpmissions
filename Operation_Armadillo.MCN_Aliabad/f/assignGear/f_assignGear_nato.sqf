...
_attach2 = "FHQ_acc_ANPEQ15";			// Flashlight
...
_carbine = "rhs_weap_m4a1_d_mstock_grip2";
...
_smg = "rhs_weap_m4a1_d_mstock_grip2";
...
_bagmediumdiver =  "tf_anprc155_coyote";		// used by divers
...
// Sniper
_SNrifle = "rhs_weap_m40a5_d";
_SNrifleMag = "rhsusf_10Rnd_762x51_m118_special_Mag";

// Spotter
_SPOTrifle = "rhs_weap_mk18_KAC_d";
_SPOTmag1 = "rhs_mag_30Rnd_556x45_M855A1_Stanag_Tracer_Red";
...
_baseUniform = ["rhs_uniform_g3_tan"];
_baseHelmet = ["rhsusf_mich_bare_tan_headset","rhsusf_mich_bare_norotos_arc_alt_tan"];
_baseGlasses = [];

// Vests
_lightRig = ["rhsusf_spc_patchless_radio"];
_mediumRig = ["rhsusf_spc_patchless_radio","rhsusf_spc_corpsman"]; 	// default for all infantry classes
_heavyRig = ["rhsusf_spc_patchless_radio"];

// Diver
_diverUniform =  ["rhs_uniform_g3_tan"];
_diverHelmet = ["H_Cap_usblack"];
_diverRig = ["V_Chestrig_khk"];
_diverGlasses = ["G_Bandanna_khk"];
...
_crewHelmet = ["rhsusf_mich_bare_tan_headset"];
_crewRig = ["rhsusf_spc_crewman"];
_crewGlasses = [];

// Ghillie
_ghillieUniform = ["rhs_uniform_g3_tan"]; //DLC alternatives: ["U_B_FullGhillie_lsh","U_B_FullGhillie_ard","U_B_FullGhillie_sard"];
_ghillieHelmet = ["H_Booniehat_khk_hs"];
_ghillieRig = ["V_Chestrig_khk"];
_ghillieGlasses = ["G_Bandanna_khk"];

// Spec Op
_sfuniform = ["rhs_uniform_g3_tan"];
_sfhelmet = ["H_Beret_Colonel"];
_sfRig = ["rhsusf_spc_squadleader"];
_sfGlasses = [];
...
// LOADOUT: MEDIC
	case "m":
	{
		_unit addmagazines [_carbinemag,12];
...
// LOADOUT: FIRE TEAM LEADER
	case "ftl":
	{
		...
		_attachments = [_attach1,_scope2,_silencer1,_bipod1];
		_unit addmagazines [_grenade,2];
		_unit addmagazines [_smokegrenade,4];
		_unit addmagazines [_smokegrenadegreen,2];
		_unit addWeapon "Rangefinder";
...
// LOADOUT: SNIPER
	case "sn":
	{
		_unit addmagazines [_SNrifleMag,15];
		_unit addweapon _SNrifle;
		_unit addmagazines [_pistolmag,6];
		_unit addweapon _pistol;
		_unit addmagazines [_smokegrenade,2];
		_attachments = [_scope3,_bipod2,_attach2];
		_unit unlinkItem _nvg;
	};
...
// LOADOUT: Diver
	case "div":
	{
		_unit addmagazines [_SPOTmag1,12];
		_unit addweapon _SPOTrifle;
		_unit addweapon _m320;
		_unit addmagazines [_grenade,2];
		_unit addmagazines [_mgrenade,2];
		_attachments = [_attach1,_scope1,_silencer2,_bipod1];
		_unit unlinkItem _nvg;
		["div"] call _backpack;
	};
...
// LOADOUT: CARABINEER
	case "car":
	{
		...
		_unit addweapon _carbine;
		_attachments = [_attach1,_scope1,_silencer1,_bipod1];
