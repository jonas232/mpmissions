...
_glsmokegreen = "rhs_VG40OP_white";
_glsmokered = "rhs_VG40OP_white";

// Flares for FTLs, Squad Leaders, etc
_glflarewhite = "rhs_GRD40_White";
_glflarered = "rhs_GRD40_White";
_glflareyellow = "rhs_GRD40_White";
_glflaregreen = "rhs_GRD40_White";
...
_baglarge =  "B_FieldPack_cbr"; 			// carries 320, weighs 40
...
// Woodland-Hex
_baseUniform = ["MNP_CombatUniform_Militia_DA", "MNP_CombatUniform_Militia_DF"];
_baseHelmet = ["H_Bandanna_cbr", "H_ShemagOpen_khk", "H_Bandanna_sand"];
_baseGlasses = [];
...
// Vests
_lightRig = ["V_BandollierB_rgr", "V_Chestrig_khk"];
_mediumRig = ["V_BandollierB_rgr", "V_Chestrig_khk"]; 	// default for all infantry classes
...
// Spec Op
_sfuniform = ["MNP_CombatUniform_Militia_DA"];
_sfhelmet = ["H_Bandanna_cbr"];
_sfRig = ["V_BandollierB_rgr", "V_Chestrig_khk"];
_sfGlasses = [];
