...
_OPFmen = ["rhs_vdv_sergeant","rhs_vdv_machinegunner","rhs_vdv_machinegunner_assistant","rhs_vdv_medic","rhs_vdv_grenadier","rhs_vdv_at"];
_INDmen = ["rhs_vdv_sergeant","rhs_vdv_machinegunner","rhs_vdv_machinegunner_assistant","rhs_vdv_medic","rhs_vdv_grenadier","rhs_vdv_at"];
_BLUchopper = "B_Heli_Transport_01_F";
_OPFchopper = "RHS_Mi8mt_Cargo_vdv";
_INDchopper = "RHS_Mi8mt_Cargo_vdv";
