...
_silencer1 = "hlc_muzzle_Tundra";		// 9mm MP5 suppressor
_silencer2 = "rhsusf_acc_rotex5_grey";	// 6.5 suppressor

_scope1 = "rhsusf_acc_eotech_xps3";		// Holosight
_scope2 = "rhsusf_acc_SpecterDR_OD";	// MRCO Scope - 1x - 6x
_scope3 = "rhsusf_acc_SpecterDR_OD";	// SOS Scope - 18x - 75x

_bipod1 = "rhs_acc_grip_ffg2";				// rhs_acc_grip_ffg2
_bipod2 = "rhs_acc_grip_ffg2";				// rhs_acc_grip_ffg2
...
// ATTACHMENTS - HANDGUN
_hg_silencer1 = "rhsusf_acc_omega9k";	// 9mm suppressor
...
_carbine = "rhs_weap_hk416d10_LMT_wd";
...
_baglarge =  "MNP_B_RU1_CA"; 				// carries 320, weighs 40
_bagmediumdiver =  "B_TacticalPack_blk";	// used by divers
...
_baseUniform = ["MNP_CombatUniform_NOR_A","MNP_CombatUniform_NOR_B"];
_baseHelmet = ["rhsusf_mich_bare_norotos_arc_alt","rhsusf_mich_bare_norotos_arc_headset","rhsusf_mich_bare_norotos_arc_alt_headset"];
_baseGlasses = [];

// Vests
_lightRig = ["MNP_Vest_NOR_1"];
_mediumRig = ["MNP_Vest_NOR_1"]; 	// default for all infantry classes
_heavyRig = ["MNP_Vest_NOR_1"];
...
// Pilot
_pilotUniform = ["rhs_uniform_cu_ocp_101st"];
_pilotHelmet = ["H_PilotHelmetHeli_B"];
_pilotRig = ["rhsusf_spcs_ocp_rifleman"];
_pilotGlasses = ["Mask_M40"];
...
// Spec Op
_sfuniform = ["MNP_CombatUniform_NOR_A"];
_sfhelmet = ["MNP_Beret_RM"];
_sfRig = ["MNP_Vest_NOR_1"];
_sfGlasses = [];
...
// LOADOUT: Diver
	case "div":
	{
		_unit addmagazines [_diverMag1,10];
		_unit addmagazines [_diverMag2,0];
...
// CARGO: TRUCK - room for 50 weapons and 200 cargo items
	case "v_tr":
	{
		...
		clearItemCargoGlobal _unit;
		clearBackpackCargoGlobal _unit;
		_unit addMagazineCargoGlobal [_riflemag, 75];
...
// CARGO: SDV -	
	...
	case "v_sdv":
	{
		...
		clearItemCargoGlobal _unit;
		clearBackpackCargoGlobal _unit;
		_unit addMagazineCargoGlobal [_divmag, 20];
	...
	case "crate_med":
{
		...
		_unit addMagazineCargoGlobal [_smokegrenadegreen, 6];
		_unit addItemCargoGlobal [_firstaid, 35];
		_unit addItemCargoGlobal [_RAT, 6];
		_unit addItemCargoGlobal [_satchel, 6];
};
